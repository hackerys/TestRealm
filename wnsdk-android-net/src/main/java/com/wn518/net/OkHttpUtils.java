...
import com.wn518.net.cookie.CookieJarImpl;
import com.wn518.net.cookie.store.MemoryCookieStore;
import com.wn518.net.https.HttpsUtils;
import com.wn518.net.https.WNTrustManager;
import com.wn518.net.interceptor.LoggerInterceptor;
import com.wn518.net.model.HttpHeaders;
import com.wn518.net.model.HttpParams;
import com.wn518.net.request.GetRequest;
import com.wn518.net.request.PostRequest;
...
public class OkHttpUtils {
    ...
    private OkHttpUtils() {
        ...
        //验证服务器证书
        TrustManager[] mTrustManagers = new TrustManager[]{new WNTrustManager()};
        try {
            sc = SSLContext.getInstance("TLS");
            sc.init(null, mTrustManagers, null);
