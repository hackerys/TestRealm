...
public class WnLogsUtils {

	/** 是否打开LOG*/
	private static boolean sIsLogEnabled = true;

	/** LOG默认TAG*/
	private static String sApplicationTag = "MYTAG";
	 ...
	 * @date 2014-10-24  
	 * @modified by
	 * @update-time 2014-10-24 下午05:37:43 
	 */
	...
	* @Description 替代默认的LogUtils.d
	...
	public static void sysPrintln(Object msg){
		if (sIsLogEnabled) {
			WnLogsUtils.d(getContent(getCurrentStackTraceElement())+"->"+msg.toString());
		}
	}
